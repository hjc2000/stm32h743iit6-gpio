...
namespace bsp
{
    ...
    public:
        static GpioPinPE10 &Instance()
        {
            class Getter :
                public base::SingletonGetter<GpioPinPE10>
            {
            public:
                std::unique_ptr<GpioPinPE10> Create() override
                {
                    return std::unique_ptr<GpioPinPE10>{new GpioPinPE10{}};
                }
