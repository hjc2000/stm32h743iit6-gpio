...
{
    class Getter :
        public bsp::TaskSingletonGetter<GpioPinPD1>
    {
    public:
...
void bsp::GpioPinPD1::OpenAsAlternateFunctionMode(std::string function_name, bsp::IGpioPinPullMode pull_mode, bsp::IGpioPinDriver driver_mode)
{
    if (_is_open)
    {
