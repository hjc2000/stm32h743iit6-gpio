...
{
    class Getter :
        public bsp::TaskSingletonGetter<GpioPinPF0>
    {
    public:
...
void bsp::GpioPinPF0::OpenAsAlternateFunctionMode(std::string function_name, bsp::IGpioPinPullMode pull_mode, bsp::IGpioPinDriver driver_mode)
{
    if (_is_open)
    {
